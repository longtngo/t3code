  ...
  it.effect.skipIf(windowsHost)(
    ...
    () =>
      Effect.gen(function* () {
        ...
        // FORK: realpath the temp root. macOS resolves TMPDIR through the
        // `/var` -> `/private/var` symlink, and the code under test realpaths
        // the prefix it reports, so a raw temp path never matches.
