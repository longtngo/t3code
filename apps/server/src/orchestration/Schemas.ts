import {
  ...
  ThreadMessageWithdrawnPayload as ContractsThreadMessageWithdrawnPayloadSchema,
...
export const ThreadMessageWithdrawnPayload = ContractsThreadMessageWithdrawnPayloadSchema;
