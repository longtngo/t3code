...
function checkpointStatusToLatestTurnState(status: "ready" | "missing" | "error") {
  ...
  // "missing" is a placeholder awaiting a real git capture, not evidence the
  // turn was interrupted - see the guard on thread.turn-diff-completed below,
  // which already treats it as a placeholder. SQL and the client agree.
