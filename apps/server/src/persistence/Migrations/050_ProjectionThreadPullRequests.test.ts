...
layer("050_ProjectionThreadPullRequests", (it) => {
  it.effect("creates the link table and backfills legacy single links", () =>
    Effect.gen(function* () {
      ...
      // Upstream numbers this migration 050; the fork applies it as 59 (registry
      // section 1). Without this control the test passes at either id, because a
      // table created earlier than intended looks exactly like one created on time.
