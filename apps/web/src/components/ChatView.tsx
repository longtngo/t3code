...
function ChatViewContent(props: ChatViewProps) {
  ...
  // The server-projected settled state keeps the banner and the sidebar row in
  // sync. Declared HERE rather than at upstream's later position because the
  // fork's held-message labelling below consumes the same shell.
