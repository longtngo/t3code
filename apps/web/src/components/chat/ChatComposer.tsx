...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const selectedInstanceId = useMemo<ProviderInstanceId>(
    () =>
      resolveSelectedComposerInstanceId({
        draftActiveProvider: composerDraft.activeProvider,
        sessionInstanceId: activeThread?.session?.providerInstanceId,
        threadSelectionInstanceId: activeThreadModelSelection?.instanceId,
        projectDefaultInstanceId: activeProjectDefaultModelSelection?.instanceId,
        selectedProvider,
        lockedProvider,
  ...
  const showTodoListSection =
    !isComposerCollapsedMobile && activePlan !== null && activePlan.steps.length > 0;
    ...
    >
      ...
      >
        ...
        >
          ...
          {showTodoListSection ? (
            <ComposerTodoList activePlan={activePlan} hasComposerHeader={hasComposerHeader} />
          ) : null}

          <div
            className={cn(
              "relative px-3 pb-2 sm:px-4",
              hasComposerHeader || showTodoListSection ? "pt-2.5 sm:pt-3" : "pt-3.5 sm:pt-4",
