...
// Upstream #8936 RELOCATED this module's work-log presentation helpers
// (`normalizeCompactToolLabel`, `toolGroupAction`, `summarizeToolGroup`,
// `toolGroupSummaryKind`, `workLogEntryIsLocalCodeSearch`,
// `omitSupersededLifecycleMarkers`) to
// `@t3tools/client-runtime/work-log/presentation`, where mobile can reach them
// too. The move is adopted rather than resisted; only the fork-only coalescing
// below stayed, because upstream has no equivalent.
