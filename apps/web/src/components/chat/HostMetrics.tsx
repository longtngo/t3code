...
/**
 * Live host CPU/GPU/memory readout for the chat header: compact bars on desktop,
 * pills on mobile, with full detail in a hover popover — mirroring the account
 * UsageMeter. A live-dot button toggles the stream to save bandwidth; when
 * disabled it collapses to a single "metrics paused" affordance.
 */
