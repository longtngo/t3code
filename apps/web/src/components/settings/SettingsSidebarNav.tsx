  ...
  return (
    <>
      ...
      <SidebarFooter className="px-[var(--sidebar-content-inset)] py-1">
        ...
        {/* FORK: items-end, not items-center — the fork's footer panels open upward from
            this row and anchor on its bottom edge (registry 5b). */}
        <div className="flex items-end gap-1 group-data-[collapsible=icon]:flex-col">
