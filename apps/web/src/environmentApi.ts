...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    projects: {
      ...
      renderMarkdownHtml: rpcClient.projects.renderMarkdownHtml,
    },
    attachments: {
      upload: rpcClient.attachments.upload,
    },
    filesystem: {
    ...
    accountUsage: {
      refresh: rpcClient.accountUsage.refresh,
    },
    hostMetrics: {
      subscribe: (callback, options) => rpcClient.hostMetrics.subscribe(callback, options),
    },
    llmModels: {
