...
// The chat prose linkifier and this module's link gate share one answer to
// "is this a filesystem path"; the predicate lives in client-runtime.
export { isKnownFilesystemRootPath } from "@t3tools/client-runtime/markdown-links";
