...
export const WORKSPACE_TEXT_VIEWER_EXTENSIONS = [
  ...
  ".toml", ".ini", ".conf", ".cfg", ".properties", ".xml", ".sql",
  // Scripting / systems languages
  ".py", ".rb", ".go", ".rs", ".java", ".kt", ".kts", ".c", ".h", ".cpp", ".cc",
  ".cxx", ".hpp", ".hh", ".cs", ".php", ".swift", ".scala", ".sh", ".bash",
  ".zsh", ".fish", ".ps1", ".lua", ".pl", ".pm", ".r", ".dart", ".ex", ".exs",
  ".erl", ".hs", ".clj", ".cljs", ".cljc", ".edn",
  // JS/TS + web frameworks
  ".js", ".cjs", ".mjs", ".jsx", ".ts", ".cts", ".mts", ".tsx", ".vue",
  ".svelte", ".astro", ".css", ".scss", ".sass", ".less",
  // Schemas / build / infra / misc
  ".graphql", ".gql", ".proto", ".gradle", ".groovy", ".tf", ".hcl", ".vim",
  ".diff", ".patch",
] as const;
